...
export const portfolioData: Portfolio[] = [
  // Example entry
  {
    title: "CPU data AI assistant TUI & independent research thesis",
    /* description:
    ...
    technologies: ["Python", "LangChain", "Ollama", "Open API", "Tableau", "Statistical Analysis", "NumPy", "Pandas", "ChromaDB", "Textualize Terminal User Interface"],
